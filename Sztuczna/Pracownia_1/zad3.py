...
def find_ppb(rounds, blotkarz_deck, figurant_deck):
    counter = 0
    ...
    return (counter / rounds) * 100

blotkarz_deck = [(i, j) for i in range(9, 11) for j in range(1, 5)]
figurant_deck = [(i, j) for i in range(11, 15) for j in range(1, 5)]


print(find_ppb(100000, blotkarz_deck, figurant_deck))
