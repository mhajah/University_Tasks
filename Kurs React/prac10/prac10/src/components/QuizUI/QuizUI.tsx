...
function QuizUI() {
  const { question, otherAnswers, correctCounter, bestScore, rollQuestion, handleCheckAnswer, loading, usedAnswers } = useGame();
    ...
    <div className='flex flex-col justify-center items-center'>
      ...
      <div className='mt-16 text-white flex flex-col pt-0 lg:w-1/3 w-2/3 h-128 bg-indigo-900 shadow-lg'>
        <div className='bg-blue-950 p-8'>
          <h6 className='text-xs mb-4 text-blue-200 float-right'>Strike: {correctCounter}</h6>
          <h6 className='text-xs mb-4 text-blue-200'>Best Score: {bestScore}</h6>
